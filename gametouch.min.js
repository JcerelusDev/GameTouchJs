...
.left::before {
  ...
  border-color: transparent rgba(255, 255, 255, 0.5) transparent transparent; /* Arrow color */
  position: absolute;
  top: 50%;
...
.right::before {
  ...
  border-color: transparent transparent transparent rgba(255, 255, 255, 0.5); /* Arrow color */
  position: absolute;
  top: 50%;
